...
orig = pd.read_excel(root_path+'/time_series/ZhangJiaShanDailyFlow1997-2014.xlsx')['DailyFlow']

# for wavelet in ['bior 3.3','coif3','db2','db5',
# 'db10','db15','db20','db25','db30','db35','db40','db45','haar']:
#     for lev in [1,2,3]:
#         for lead in [1,3,5,7]:
